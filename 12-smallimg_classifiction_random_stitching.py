...
for i in range(1):
    ...
    csv_file_path = './test_quanliucheng/test/' + yao_id + '_test_csv/pred_sui.csv'  # 指定 CSV 文件路径
    csv_file_path_four = './test_quanliucheng/test/' + yao_id + '_test_csv/pred_sui_four.csv'  # 指定 CSV 文件路径
    test_csv_path = './test_quanliucheng/test/' + yao_id + '_test_csv/smallimg_yao_sui.csv'
    ...
    # 自身拼接训练出的模型
    # model_path = "model_10kind_dense/model_10kind_dense169_quan_self_second_2.mdl"
    # 随机拼接训练出的模型
    model_path = "./models/swin/small/model_10kind_swin_sui_8.mdl"
    print(model_path)
